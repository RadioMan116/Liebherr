...
$(document).ready(function () {
	...
	$(".js-glossary").click(function () {
		$(this).toggleClass('closed')
	});
	$(".button__half-open").click(function () {
		$(this).parent().addClass('half-open');
		$(this).hide();
	});
	$(".button__open").click(function () {
		if (!$(this).parent().hasClass('open')) {
			console.log('sdjgjsgSI:OHG')
			$(this).parent().addClass('open');
			$(this).addClass('open');
		} else {
			$(this).parent().removeClass('open');
			$(this).parent().removeClass('half-open');
			$(this).removeClass('open');
			$(".button__half-open").show();
		}
	...
	$(".js-characteristic__title").click(function () {
		if (!$(this).hasClass("characteristic__title-active")) {
			...
			$(this).nextUntil('tr.characteristic__title').hide();
			$(this).removeClass('characteristic__title-active');
		}
	});
